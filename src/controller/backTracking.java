...
public class backTracking {
    ...
    private boolean placeQueen(Integer[][] board, int row, int col) {
        int i, j;
    ...
    private boolean applyBackTrackingCol(Integer[][] board, int row, int col) {
        /* base case */
        int noOfQueens = 0;
    ...
    private boolean applyBackTrackingRow(Integer[][] board, int row, int col) {
        /* base case */
        int noOfQueens = 0;
        for (int nr = 0; nr < getN(); nr++) {
            for (int nc = 0; nc < getN(); nc++) {
                    ...
                    for (int j = 0; j < getN(); j++) {
                        if (nQueenBoard.holdsQueen(m, j)) {
                            ...
                            while (tempCol < getN()) {
                                ...
                                if (applyBackTrackingCol(nQueenBoard.getBoard(), (tempRow == -1) ? ++tempRow : tempRow, ++tempCol) == true && nextPossibility() == true) {
                                    sol = true;
                                    break;
                                }
                            }
                            ...
                            while (tempRow < getN()) {
                                nQueenBoard.refreshBoard();
                                if (applyBackTrackingRow(nQueenBoard.getBoard(), ++tempRow, (tempCol == -1) ? ++tempCol : tempCol) == true && nextPossibility() == true) {
                                    sol = true;
                                    break;
                                }
                            }
    ...
    private boolean nextPossibility() {
